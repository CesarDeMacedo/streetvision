...
const en = {
  ...
  'login.viewDemo': 'View a live demo without an account →',

  'demo.badge': 'PUBLIC DEMO',
  'demo.title': 'StreetVision AI — Demo',
  'demo.subtitle': 'Parnell Rd · protected bike lanes on both sides of the street',
  'demo.notice':
    'This is a fixed demonstration with a pre-generated result — it does not generate new images. The photo is a real street; the "after" was generated by StreetVision AI preserving facades, camera angle, lighting and the street name painted on the asphalt.',
...
const fr: Record<MessageKey, string> = {
  ...
  'login.viewDemo': 'Voir une démo sans compte →',

  'demo.badge': 'DÉMO PUBLIQUE',
  'demo.title': 'StreetVision AI — Démo',
  'demo.subtitle': 'Parnell Rd · pistes cyclables protégées des deux côtés de la rue',
  'demo.notice':
    "Ceci est une démonstration fixe avec un résultat pré-généré — elle ne génère pas de nouvelles images. La photo est une rue réelle ; l'« après » a été généré par StreetVision AI en préservant les façades, l'angle de caméra, l'éclairage et le nom de rue peint sur la chaussée.",
...
const pt: Record<MessageKey, string> = {
  ...
  'login.viewDemo': 'Ver demonstração sem conta →',

  'demo.badge': 'DEMONSTRAÇÃO PÚBLICA',
  'demo.title': 'StreetVision AI — Demonstração',
  'demo.subtitle': 'Parnell Rd · ciclovias protegidas nos dois lados da rua',
  'demo.notice':
